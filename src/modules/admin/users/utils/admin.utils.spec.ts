...
describe('admin.utils', () => {
  ...
  describe('getPlatformRole', () => {
    ...
    it('should handle role arrays — falls back to member when no superadmin/admin/manager (line 13)', () => {
      expect(
  ...
  describe('requireActiveOrganizationIdForManager', () => {
    ...
    it('should return orgId for admin with active organization', () => {
      expect(
        requireActiveOrganizationIdForManager('admin', {
          session: { activeOrganizationId: 'org-1' },
        } as any),
      ).toBe('org-1');
    });
    ...
    it('should throw ForbiddenException for admin without active organization', () => {
      expect(() =>
