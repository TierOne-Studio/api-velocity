...
import type { IKnowledgeBaseRepository } from '../../domain/knowledge-base.repository';
...
function buildRepositoryMock(): jest.Mocked<IKnowledgeBaseRepository> {
  return {
    create: jest.fn(),
    update: jest.fn(),
  ...
  } as unknown as jest.Mocked<IKnowledgeBaseRepository>;
}

function buildRow(overrides: Partial<KnowledgeBaseRow> = {}): KnowledgeBaseRow {
  return {
    id: 'kb-1',
...
describe('KnowledgeBaseService.list', () => {
...
describe('KnowledgeBaseService.delete', () => {
...
describe('KnowledgeBaseService.requireOrg (non-superadmin)', () => {
