...
behavior to match code that is actually wrong). This containment is enforced mechanically in CI.
...
## Forbidden behaviors
- Editing anything outside `docs/specs/**` (never src/, tests, migrations, config, ADRs, .ruler/, skills, CLAUDE.md).
